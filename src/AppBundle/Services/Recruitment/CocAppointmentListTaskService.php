...
class CocAppointmentListTaskService extends ServiceHelper
{
    private $connection;
     ...
     */
    public function importFromCSV($mysqlLoadCSVPath, CocAppointmentList $cocAppointmentList): int
    {
        $affectedRows = 0;
        $statement = null;
        ...
        try {
            ...
            $query = "LOAD DATA INFILE '$mysqlLoadCSVPath'
                    INTO TABLE recruitment_coc_appointment_list_entries_staging 
                    FIELDS TERMINATED BY ',' 
                    OPTIONALLY ENCLOSED BY '\"' 
                    LINES TERMINATED BY '\n' 
                    (recruitment_coc_appointment_list_id, serial_no, surname, first_name, other_names, date_of_birth
            ...
            $query = "SELECT count(*) FROM recruitment_coc_appointment_list_entries_staging WHERE recruitment_coc_appointment_list_id=:recruitment_coc_appointment_list_id";
            ...
            $query = "UPDATE recruitment_coc_appointment_list SET total_candidates=:total_candidates "
                . " WHERE id=:id";
            $statement = $this->connection->prepare($query);
     ...
     * @throws \Doctrine\DBAL\ConnectionException
     */
    public function importMultiInsert($candidates, CocAppointmentList $cocAppointmentList): int
    {
        $affectedRows = 0;
        $statement = null;
        ...
        try {
            ...
            foreach ($candidates as $candidate) {
                ...
                $candidateDataRecord['recruitment_coc_appointment_list_id'] = $this->getValueOrNull($candidate[0]);
            ...
            $outcome = $this->pdoMultiInsertReturnTotal('recruitment_coc_appointment_list_entries_staging', $batchCandidateData);
            ...
            $query = "UPDATE 
                    recruitment_coc_appointment_list 
