...
class ManageProfileController extends Controller
{
    ...
    /**
     * @Route("/secure_area/user_account/profile/edit",name="user_profile_edit")
     */
    public function editUserProfileActionAction(Request $request)
    {
        ...
        return $this->render("secure_area/user_account_profile/user_profile_edit.html.twig",
            array(
