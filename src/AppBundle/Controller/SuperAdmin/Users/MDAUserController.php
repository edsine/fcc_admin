...
class MDAUserController extends Controller
{

    /**
     * @Route("/super_admin/mda_user/list", name="mda_user_list")
     */
    public function listAction(Request $request)
    {
        ...
        $searchFilter = new UserProfileSearchCriteria(AppConstants::MDA_USER_PROFILE);
        ...
        $searchFilter->setOrganization($request->request->get('searchOrganization'));
        ...
        return $this->render('super_admin/mda_users/mda_user_list.html.twig',
    ...
    /**
     * @Route("/super_admin/mda_user/new",name="mda_user_new")
     */
    public function newAction(Request $request)
    {
        ...
        $mdaRoles = $sharedDataManager->getMDARoles();
        $nigerianStates = $sharedDataManager->getNigerianStates();

        return $this->render('super_admin/mda_users/fed_mda_user_new.html.twig',
            array(
    ...
    /**
     * @Route("/super_admin/mda_user/{guid}/edit",name="mda_user_edit")
     */
    public function editAction($guid, Request $request)
    {
        ...
        return $this->render('super_admin/mda_users/fed_mda_user_edit.html.twig',
            array(
                'userProfile' => $userProfile,
                'validator' => $validator,
                'outcome' => $outcome,
    ...
    /**
     * @Route("/super_admin/mda_user/{guid}/delete",name="mda_user_delete")
     */
    public function deleteAction($guid, Request $request)
    {
            ...
            if (!$validator->getFields()->hasErrors()) {
                ...
                try {
                    ...
                    if ($outcome) {
                        ...
                        return $this->redirectToRoute('mda_user_list');
        ...
        return $this->render('super_admin/mda_users/fed_mda_user_delete.html.twig',
            array(
                'userProfile' => $userProfile,
                'validator' => $validator,
                'outcome' => $outcome,
    ...
    private function initializeValidationFields(Validator $validator, string $which)
    {
        ...
        $validator->getFields()->addField('organization', "Establishment is required");
    ...
    {
        $validator->textRequiredMax('username', $userProfile->getUsername(),true, 8, 60);
        $validator->textRequiredMax('first_name', $userProfile->getFirstName(),true, 8, 60);
        $validator->textRequiredMax('last_name', $userProfile->getLastName(),true, 8, 60);
        ...
        $validator->required('organization', $userProfile->getOrganizationId());
    ...
    private function fillModelFromRequest(Request $request)
    {
        ...
        $userProfile->setOrganizationId($request->request->get("organization"));
