...
class FederalParastatalController extends Controller
{

    /**
     * @Route("/super_admin/federal_parastatal/list", name="federal_parastatal_list")
     */
    public function listAction(Request $request)
    {
        ...
        $searchFilter = new OrganizationSearchCriteria(AppConstants::FEDERAL_PARASTATAL_ESTABLISHMENT);
        ...
        return $this->render('super_admin/organization/federal_parastatal_list.html.twig',
    ...
    /**
     * @Route("/super_admin/federal_parastatal/new",name="federal_parastatal_new")
     */
    public function newAction(Request $request)
    {
        ...
        if ($request->request->has("btnSubmit")) {
            ...
            if (!$validator->getFields()->hasErrors()) {
                ...
                $organization->setEstablishmentTypeId(AppConstants::FEDERAL_PARASTATAL_ESTABLISHMENT);
        ...
        $parentOrganizations = $sharedDataManager->getOrganizationByType(AppConstants::FEDERAL_MINISTRY_ESTABLISHMENT);



        return $this->render('super_admin/organization/federal_parastatal_new.html.twig',
            array(
    ...
    /**
     * @Route("/super_admin/federal_parastatal/{guid}/edit",name="federal_parastatal_edit")
     */
    public function editAction($guid, Request $request)
    {
        ...
        return $this->render('super_admin/organization/federal_parastatal_edit.html.twig',
            array(
                'organization' => $organization,
                'validator' => $validator,
                'outcome' => $outcome,
    ...
    /**
     * @Route("/super_admin/federal_parastatal/{guid}/delete",name="federal_parastatal_delete")
     */
    public function deleteAction($guid, Request $request)
    {
            ...
            if (!$validator->getFields()->hasErrors()) {
                ...
                try {
                    ...
                    if ($outcome) {
                        ...
                        $this->get('app.shared_data_manager')->removeCacheItem(AppConstants::KEY_CACHED_ORGANIZATIONS);
                        return $this->redirectToRoute('federal_parastatal_list');
        ...
        return $this->render('super_admin/organization/federal_parastatal_delete.html.twig',
            array(
                'organization' => $organization,
                'validator' => $validator,
                'outcome' => $outcome,
    ...
    private function validateForm(Validator $validator, Organization $organization, string $which)
    {
        ...
        $validator->required('parent_organization', $organization->getParentOrganizationId());
