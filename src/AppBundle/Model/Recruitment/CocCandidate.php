...
class CocCandidate
{
    ...
    private $recruitmentCocId, $recruitmentCocSelector;
    private $serialNo;
     ...
     * @return mixed
     */
    public function getRecruitmentCocId()
    {
        return $this->recruitmentCocId;
    }

    /**
     * @param mixed $recruitmentCocId
     */
    public function setRecruitmentCocId($recruitmentCocId)
    {
        $this->recruitmentCocId = $recruitmentCocId;
    }

    /**
     * @return mixed
     */
    public function getRecruitmentCocSelector()
    {
        return $this->recruitmentCocSelector;
    }

    /**
     * @param mixed $recruitmentCocSelector
     */
    public function setRecruitmentCocSelector($recruitmentCocSelector)
    {
        $this->recruitmentCocSelector = $recruitmentCocSelector;
    }
